...
class User_CharacterTest extends PHPUnit_Framework_TestCase
{
	...
	public function testFindCharacter()
	{
		...
		$character = User_Character::Factory(1);
	...
	public function testFindCharacterByName()
	{
		...
		$character = User_Character::Factory('foo', User_Character::SEARCH_BY_NAME);
		$this->assertEquals(1, $character->GetGuid());
	}
	...
	public function testIfFindCharacterTwoTimes($key, $searchBy)
	{
		...
		$character1 = User_Character::Factory(1);
		$character1->SetMoney(0, 0);
		
		$character2 = User_Character::Factory($key, $searchBy);
	...
	{
		return array(
			array(1, User_Character::SEARCH_BY_GUID),
			array('foo', User_Character::SEARCH_BY_NAME),
		);
	}
};
